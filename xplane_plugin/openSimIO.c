...
PLUGIN_API int XPluginStart(char *outName, char *outSig, char *outDesc) {
   strcpy(outName, "MFD39");
   strcpy(outSig, "github.condac.MFD39");
   strcpy(outDesc, "A plug-in for MFD39.");
   ...
   myMenu = XPLMCreateMenu("MFD39", XPLMFindPluginsMenu(), mySubMenuItem,       /* Menu Item to attach to. */
